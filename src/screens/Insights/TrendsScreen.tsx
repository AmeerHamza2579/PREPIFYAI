      ...
      <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/insights/predict' as never)}
            accessibilityRole="button"
            accessibilityLabel="Open topic prediction screen"
          >
            <Text style={styles.linkTxt}>Predict topic for a question (DistilBERT) →</Text>
          </TouchableOpacity>
