...
export default function HomeScreen() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      description: 'Which subjects and topics show up most in past papers',
      icon: LineChart,
    ...
    },
    {
      ...
      description: 'DistilBERT ranks textbook topics for any exam-style question',
      icon: Tags,
      route: '/insights/predict',
    },
  ];
